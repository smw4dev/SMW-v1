      ...
      <div className="flex flex-col lg:flex-row justify-center items-center gap-10 lg:gap-14 max-w-screen-xl mx-auto">
        <div className="flex flex-col gap-3 max-w-xl">
          ...
          <p className="text-lg text-justify text-[#dedede]">
            , মেডিকেল কলেজে ভর্তিচ্ছু শিক্ষার্থীদের জীবনের সবচাইতে নাজুক কিন্তু
            গুরুত্বপূর্ণ সময়ে স্বার্থহীন দিকনির্দেশনার দায়িত্ব কাঁধে তুলে
            নিয়েছে স্বেচ্ছায়। ১৯৮০ সালে প্রতিষ্ঠার পর থেকে আজ পর্যন্ত ছুঁয়েছে
            অজস্র প্রাণ, অসংখ্য হাসিমুখ। সাদা অ্যাপ্রনকে সঙ্গী করবার এই যাত্রায়
            তোমাকেও স্বাগত জানাচ্ছি, বন্ধু।
          </p>
        </div>

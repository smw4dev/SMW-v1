...
export const usersTable = [
  ...
  },
  {
    ...
    batch: "A",
    age: "28",
    avatar: "https://johnmitchellphoto.com/wp-content/uploads/2018/02/191_ZINGER_1_17.png",
...
export const paymentsTable: PaymentRecord[] = [
  ...
  {
    id: 201,
    invoice: "INV-2024-T001",
    studentId: "STU-0001",
    studentName: "Tony Reichert",
    studentEmail: "tony.reichert@example.com",
    avatar: "https://i.pravatar.cc/150?u=a042581f4e29026024d",
    amount: 1450,
  ...
  {
    id: 202,
    invoice: "INV-2024-Z001",
    studentId: "STU-0002",
    studentName: "Zoey Lang",
    studentEmail: "zoey.lang@example.com",
    avatar: "https://i.pravatar.cc/150?u=a042581f4e29026704d",
    amount: 1325,
  ...
  {
    id: 203,
    invoice: "INV-2024-J001",
    studentId: "STU-0003",
    studentName: "Jane Fisher",
    studentEmail: "jane.fisher@example.com",
    avatar: "https://i.pravatar.cc/150?u=a04258114e29026702d",
    amount: 1180,
  ...
  {
    id: 204,
    invoice: "INV-2024-W001",
    studentId: "STU-0004",
    studentName: "William Howard",
    studentEmail: "william.howard@example.com",
    avatar: "https://i.pravatar.cc/150?u=a048581f4e29026701d",
    amount: 980,
  ...
  {
    id: 205,
    invoice: "INV-2024-K001",
    studentId: "STU-0005",
    studentName: "Kristen Copper",
    studentEmail: "kristen.cooper@example.com",
    avatar: "https://i.pravatar.cc/150?u=a092581d4ef9026700d",
    amount: 990,
...
export type StudentAdmissionDetail = {
  ...
  paymentPlan: string
  documents: Array<{ label: string; status: 'received' | 'pending' }>
  notes: string
}

export const studentAdmissions: StudentAdmissionDetail[] = [
  {
    studentId: 1,
    applicationId: "APP-2024-3581",
    guardianName: "Maruf Reichert",
    guardianRelation: "Father",
    guardianPhone: "+880 1790-112233",
    guardianEmail: "maruf.reichert@example.com",
    address: "House 12, Road 8, Uttara, Dhaka",
    previousSchool: "Maple Leaf International School",
    enrolledProgram: "HSC Science (XI)",
    session: "Morning Shift 2024-25",
    admissionDate: "2024-07-15T04:00:00Z",
    paymentPlan: "Full payment",
    documents: [
      { label: "Birth Certificate", status: 'received' },
      { label: "Transfer Certificate", status: 'received' },
      { label: "SSC Transcript", status: 'pending' },
    ],
    notes: "Interested in robotics club and math olympiad.",
  },
  {
    studentId: 2,
    applicationId: "APP-2024-3620",
    guardianName: "Shirin Lang",
    guardianRelation: "Mother",
    guardianPhone: "+880 1711-445566",
    guardianEmail: "shirin.lang@example.com",
    address: "Apartment 9B, Bashundhara R/A, Dhaka",
    previousSchool: "Scholastica",
    enrolledProgram: "HSC Business Studies",
    session: "Day Shift 2024-25",
    admissionDate: "2024-07-18T04:00:00Z",
    paymentPlan: "Monthly installments",
    documents: [
      { label: "Birth Certificate", status: 'received' },
      { label: "Guardian NID", status: 'received' },
      { label: "SSC Transcript", status: 'received' },
    ],
    notes: "Prefers evening tutoring support for accounting.",
  },
  {
    studentId: 3,
    applicationId: "APP-2024-3792",
    guardianName: "Julian Fisher",
    guardianRelation: "Father",
    guardianPhone: "+880 1967-223344",
    guardianEmail: "julian.fisher@example.com",
    address: "House 5, Road 3, Gulshan 2, Dhaka",
    previousSchool: "Sunbeams School",
    enrolledProgram: "O Level (Year 10)",
    session: "Spring 2024",
    admissionDate: "2024-06-30T04:00:00Z",
    paymentPlan: "Quarterly installments",
    documents: [
      { label: "Passport Copy", status: 'received' },
      { label: "Previous Report Card", status: 'received' },
      { label: "Vaccination Card", status: 'pending' },
    ],
    notes: "Needs accommodation for debating competitions.",
  },
  {
    studentId: 4,
    applicationId: "APP-2024-3810",
    guardianName: "Sadia Howard",
    guardianRelation: "Mother",
    guardianPhone: "+880 1833-998877",
    guardianEmail: "sadia.howard@example.com",
    address: "House 22, Road 4, Dhanmondi, Dhaka",
    previousSchool: "Mastermind",
    enrolledProgram: "A Level (Year 12)",
    session: "Evening Shift 2024",
    admissionDate: "2024-06-20T04:00:00Z",
    paymentPlan: "Full payment",
    documents: [
      { label: "Birth Certificate", status: 'received' },
      { label: "Guardian NID", status: 'pending' },
      { label: "AS Level Transcript", status: 'received' },
    ],
    notes: "Requires hostel accommodation from August.",
  },
  {
    studentId: 5,
    applicationId: "APP-2024-3844",
    guardianName: "Imran Copper",
    guardianRelation: "Father",
    guardianPhone: "+880 1710-667788",
    guardianEmail: "imran.copper@example.com",
    address: "House 13, Road 2, Baridhara, Dhaka",
    previousSchool: "BISC",
    enrolledProgram: "HSC Humanities",
    session: "Morning Shift 2024-25",
    admissionDate: "2024-07-01T04:00:00Z",
    paymentPlan: "Monthly installments",
    documents: [
      { label: "Birth Certificate", status: 'received' },
    ...
    notes: "On merit scholarship. Interested in theatre club.",
  },
  {
    studentId: 6,
    applicationId: "APP-2024-3899",
    guardianName: "Nadia Reichert",
    guardianRelation: "Mother",
    guardianPhone: "+880 1998-221144",
    guardianEmail: "nadia.reichert@example.com",
    address: "House 44, Road 7, Banani, Dhaka",
    previousSchool: "Green Herald",
    enrolledProgram: "SSC (Class 10)",
    session: "Day Shift 2024",
    admissionDate: "2024-06-10T04:00:00Z",
    paymentPlan: "Quarterly installments",
    documents: [
      { label: "Birth Certificate", status: 'received' },
      { label: "Guardian NID", status: 'received' },
    ...
    notes: "Preparing for math olympiad training camp.",
  },
]

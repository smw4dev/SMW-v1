...
class AdmissionApplicationAdmin(admin.ModelAdmin):
    list_display = (
        "id", "student_first_name_en", "student_last_name_en",
        "current_class", "batch", "is_submitted", "is_reviewed", "is_approved",
        "created_at",
    )
    list_filter = ("is_submitted", "is_reviewed", "is_approved", "current_class", "batch")
    search_fields = (
